...
<html lang="en">
  ...
  <body class="bg-primary text-secondary">
    ...
    <nav class="w-full h-[8rem] bg-pink-300 transition-all ease-in-out lg:h-20 z-10 lg:px-12 px-10 fixed top-0 left-0">
      ...
      <div
        id="menubar"
        class="lg:hidden py-[20%] h-screen w-[72%] text-center bg-lightblack fixed top-0 left-0 translate-x-[-110%] transition-[transform] duration-300 ease-in-out"
      >
    ...
    <header
      id="header"
      class="w-full relative lg:pt-24 pt-36 pb-20 lg:min-h-[36rem] min-h-[35vh]"
    >
      <div
        class="homeexchange-container min-h-fit lg:max-h-[35rem] px-4 lg:px-12"
      >
        <!-- ------------- left side icons ------------------------ -->

        <div
          class="leftbar h-[90%] lg:grid hidden absolute left-0 bottom-[2%] text-center"
        >
        ...
        <div
          class="rightbar z-10 absolute right-20 top-[39%] text-6xl cursor-pointer hidden lg:flex flex-col-reverse gap-8"
        >
        ...
        <div class="homeexchange-box w-full grid mx-auto">
          ...
          <div class="content pt-14 pl-6 mx-auto capitalize">
            <h1
              class="text-4xl md:text-[4.5rem] md:tracking-wider md:leading-[5rem] font-bold font-heading"
            >
            ...
            <div class="imgbox h-full background-slider flex">
              ...
              <div class="box">
                <div class="image w-[280px]">
                  <img
                    src="../assets//pexels-andrea-piacquadio-845434.jpg"
                    alt=""
                  />
                </div>
              </div>
              ...
              <div class="box">
                <div class="image w-[280px]">
                  <img
                    src="../assets//pexels-andrea-piacquadio-974911.jpg"
                    alt=""
                  />
                </div>
              </div>
    ...
    <main class="w-full">
      ...
      <section id="product-type" class="grid lg:min-h-[44rem]">
        ...
        <div
          class="boxes h-full w-full relative border-[1px] border-l-lightblack overflow-hidden transition-all ease-in-out duration-1000"
        >
          <!-- ---------- background-text ------------- -->

          <div
            class="back absolute opacity-10 text-[10rem] tracking-wide font-bold top-[22%] left-[-32px] -z-10"
          >
            Men's
          </div>
          ...
          <div class="content h-full px-8">
            <div class="text p-8 lg:pl-16">
              <h5
                class="lg:text-2xl text-lg leading-10 underline font-bold text-extra"
              >
                Starting From <br />
                <span class="lg:text-4xl text-2xl text-third no-underline"
                  >$29,-</span
                >
              </h5>
              ...
              <button
                class="rounded-md px-4 py-[6px] text-sm border-extra mt-4 border-[1.5px]"
              >
                Browse
              </button>
            </div>
            ...
            <div class="image w-full h-full pt-8 overflow-hidden">
              <img
                class="w-full object-contain scale-[1.1] aspect-square"
                src="../assets/men.png"
                alt=""
              />
            </div>
      ...
      <section
        id="features"
        class="products-2 w-full min-h-[28vh] lg:min-h-[30rem] relative p-12"
      >
        <h2
          class="text-3xl font-heading border-b-2 pb-1 mb-8 border-secondary inline-block"
        >
          Feartured Gears
        </h2>

        <div
          class="product-box lg:overflow-hidden overflow-visible overflow-y-hidden"
        >
          <div
            class="items h-full lg:px-10 flex gap-10 lg:gap-16 text-center"
          ></div>
        </div>
      ...
      <section
        id="features"
        class="products-1 w-full min-h-[28vh] lg:min-h-[30rem] relative p-12"
      >
        <h2
          class="text-5xl lg:text-3xl font-heading border-b-2 pb-1 mb-12 lg:mb-8 border-secondary inline-block"
        >
          Feartured Gears
        </h2>
        ...
        <div class="salebox grid h-full">
          <div class="box box-1 my-16 bg-slate-50 relative">
            ...
            >
              ...
              <li
                class="text-3xl border-b-2 border-pink-500 text-pink-500 font-semibold mb-12"
              >
                Winter collections
              </li>
              <li
          ...
          <div class="box box-2 overflow-hidden text-left">
            <div
              class="item pr-20 py-12 h-[26rem] flex flex-row align-middle transition-all duration-300 ease-in-out"
            >
              <div class="image ml-20 mr-8 w-[35%] relative">
                <img
                  class="object-contain w-[100%] aspect-square"
                  src="../assets//sale-1.png"
                  alt=""
                />

                <div
                  class="offertag bg-secondary rounded-[50%] inline-block py-5 text-center px-4 text-sm capitalize absolute right-0 top-[-5%]"
                >
      ...
      <section id="user" class="max-h-[37rem] p-22 flex py-20 px-44">
        <div class="services">
          <div
            class="servicebox text-lightblack bg-purple-200 flex align-middle justify-center p-4"
          >
          ...
          <div
            class="servicebox text-lightblack bg-sky-300 flex align-middle justify-center p-4"
          >
          ...
          <div
            class="servicebox bg-green-600 text-primary flex align-middle justify-center p-4"
          >
          ...
          <div
            class="servicebox bg-black text-primary flex align-middle justify-center p-4"
          >
        ...
        <div class="clients pl-8 overflow-hidden">
          ...
          <div
            class="imgslider relative mt-8 transition-all ease-in-out duration-300"
          >
            <div class="clientbox absolute">
              <div
                class="image w-28 h-28 overflow-hidden rounded-full border-2"
              >
                <img
              ...
              <h5
                class="text-lg font-normal text-lightblack border-l-2 border-lightblack px-4 my-4"
              >
      ...
      <section id="contact" class="w-full h-60 p-12">
        <h2
          class="text-3xl font-bold font-heading border-b-2 border-secondary inline-block"
        >
          Newsletter
        </h2>
      </section>
